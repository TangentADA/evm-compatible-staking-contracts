 ...
 */
contract TokenFarm is Context, Ownable, ReentrancyGuard, Pausable {
    ...
    /**
     * Store farming rewards to TangentTokenFarm contract, in order to pay the user interest later.
     *
